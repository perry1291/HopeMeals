...
const prompts = [
    ...
    ["nearby ngos", "food donation organizations"],
    ["tell joke"],
  ...
  const replies = [
    ...
    ["I am the HopeMeals virtual assistant, designed to help users with food donation-related information."], 
    ["I am chitti"],
    ...
    ["Haha!","Good one!"],
    ["  The basic concept of this project HopeMeals is to collect theexcess/leftover food from donors such as hotels, restaurants, marriage halls, etc and distribute to  the  needy people"],
    [currentdate],
    [time],
    ["you can donate raw ,cooked and packed foods"],
    ["Please contact nearby registered NGOs, food banks, or charitable organizations to arrange food donations in your area."],
    ["joke ha ha .."],
